...
public interface UserService {
	 ...
	 */
	List<User> getUserList(@Param("page") Integer page, @Param("count") Integer count,
	 ...
	 * @param count 每页显示的记录数
	 * @param keywords 查询关键字
	 * @return 数据库字段映射的map的list集合
	 */
	List<Map<String, Object>> getUserListMap(@Param("page") Integer page, @Param("count") Integer count,
											 @Param("keywords") String keywords);
	 ...
	 * @return 成功更新删除标志的个数
	 */
	boolean deleteUserByIds02(@Param("ids") int[] ids);
	 ...
	 * @return 登陆成功-->1，登录失败-->0
	 */
	int login02(String username, String password);
